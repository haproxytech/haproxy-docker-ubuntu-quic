...
-	[`3.3-dev3`, `3.3`](https://github.com/haproxytech/haproxy-docker-ubuntu-quic/blob/main/3.3/Dockerfile)
-	[`3.2.3`, `3.2`, `latest`](https://github.com/haproxytech/haproxy-docker-ubuntu-quic/blob/main/3.2/Dockerfile)
-	[`3.1.8`, `3.1`](https://github.com/haproxytech/haproxy-docker-ubuntu-quic/blob/main/3.1/Dockerfile)
-	[`3.0.11`, `3.0`](https://github.com/haproxytech/haproxy-docker-ubuntu-quic/blob/main/3.0/Dockerfile)
-	[`2.9.15`, `2.9`](https://github.com/haproxytech/haproxy-docker-ubuntu-quic/blob/main/2.9/Dockerfile)
-	[`2.8.15`, `2.8`](https://github.com/haproxytech/haproxy-docker-ubuntu-quic/blob/main/2.8/Dockerfile)
-	[`2.6.22`, `2.6`](https://github.com/haproxytech/haproxy-docker-ubuntu-quic/blob/main/2.6/Dockerfile)
...
```dockerfile
FROM haproxytech/haproxy-ubuntu-quic:3.0
...
```console
$ docker run -d --name my-running-haproxy -v /path/to/etc/haproxy:/usr/local/etc/haproxy:ro haproxytech/haproxy-ubuntu-quic:3.0
```
